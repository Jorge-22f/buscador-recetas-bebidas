...
<template>
    <header class="bg-slate-800" :class="{ header: paginaInicio }">
        <div class="mx-auto container px-5 py-16">
            <div class="flex justify-between items-center">
                <div>
                    <RouterLink :to="{ name: 'inicio' }">
                        <img class="w-32" src="/img/logo.svg" alt="Logotipo pagina" />
                    </RouterLink>
                </div>
            ...
            <form class="md:w1/2 2xl:w-1/3 bg-orange-400 my-32 p-10 rounded-lg shadow space-y-6" v-if="paginaInicio"
                ...
                <div class="space-y-5">
                    ...
                    <input id="ingrediente" type="text" class="p-3 w-full rounded-lg focus:outline-none"
                        placeholder="Nombre o ingrediente" v-model="store.busqueda.nombre">
                </div>
